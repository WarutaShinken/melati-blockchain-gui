...
global.daemon_rpc_ws = `wss://${self_hostname}:57400`;
...
function loadConfig(net) {
  try {
    // check if MELATI_ROOT is set. it overrides 'net'
    ...
    const daemon_port = lodash.get(config, 'ui.daemon_port', 57400); // jshint ignore:line
