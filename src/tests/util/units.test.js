...
describe('units', () => {
  describe('#getUnit', () => {
    it('gets unit of melati', () => {
      const result = units.getUnit('melati');
    ...
    it('gets unit of melati using alias', () => {
  ...
  describe('#getDisplay', () => {
    it('gets display of melati', () => {
      const result = units.getDisplay('melati');
  ...
  describe('#setUnit', () => {
    ...
    it('modifies an existing unit', () => {
      units.setUnit('melati', 9);

      const result = units.getUnit('melati');

      expect(result).toEqual(9);

      units.setUnit('melati', 1);
    });
  });
  describe('#setDisplay', () => {
