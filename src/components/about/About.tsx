...
import icon from '../../assets/img/melati_circle.svg';
...
const url = 'https://melatinetwork.org';
    ...
    <html>
      ...
      <body>
        ...
        <div className="copyright">
          Copyright (c) 2021 Chia Network, Melati Network
        </div>
        <Spacer />
        <VersionsTable>
          {versions?.electron && (
        ...
        <BugReport href="https://github.com/Melati-Network/melati-blockchain/issues" target="_blank">
          Report an issue
        </BugReport>
        {'{{CSS}}'}
      </body>
