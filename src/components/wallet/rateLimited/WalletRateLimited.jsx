...
const IncompleteCard = (props) => {
  ...
  function submit() {
    ...
    const melatiper_input = ip_parsed.limit;
    ...
    const melatiper_value = Number.parseInt(Number(melatiper_input));
        ...
        <Grid item xs={12}>
          <Box display="flex">
            ...
            <Box flexGrow={1}>
              <Typography variant="subtitle1">
                <Trans>
                  Spending Limit (melati per interval):{' '}
                  {mojo_to_melati_string(limit)}
                </Trans>
              </Typography>
            </Box>
          </Box>
