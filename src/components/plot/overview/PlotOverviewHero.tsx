...
import { CardHero, Link } from '@melati/core';
        ...
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              ...
              <Link target="_blank" href="https://github.com/Flax-Network/melati-blockchain/wiki/Network-Architecture">Learn more</Link>
            </Trans>
          </Typography>
          <Button
