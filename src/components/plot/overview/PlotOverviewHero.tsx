...
import { CardHero, Flex, Link } from '@melati/core';
import { PlotHero as PlotHeroIcon } from '@melati/icons';
      ...
      <Grid xs={12} md={6} lg={5} item>
        <CardHero>
          ...
          <Typography variant="body1">
            <Trans>
              {
                'Plots are allocated space on your hard drive used to farm and earn Melati. '
              }
              <Link
                target="_blank"
                href="https://github.com/Melati-Network/melati-blockchain/wiki/Network-Architecture"
              >
                Learn more
              </Link>
            </Trans>
